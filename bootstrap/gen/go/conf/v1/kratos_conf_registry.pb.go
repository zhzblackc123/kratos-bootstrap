...
const file_conf_v1_kratos_conf_registry_proto_rawDesc = "" +
	...
	"\n" +
	"\b_polarisB\x0e\n" +
	"\f_servicecombB\x90\x01\n" +
	"\bcom.confB\x17KratosConfRegistryProtoP\x01Z;github.com/zhzblackc123/kratos-bootstrap/api/gen/go/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
