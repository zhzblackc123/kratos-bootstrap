...
type Data struct {
	...
	BusinessMongodb *Data_MongoDB          `protobuf:"bytes,15,opt,name=business_mongodb,json=businessMongodb,proto3,oneof" json:"business_mongodb,omitempty"` // 业务MongoDB数据库（用于管理BangBangKe应用用户）
...
func (x *Data) GetBusinessMongodb() *Data_MongoDB {
	if x != nil {
		return x.BusinessMongodb
	}
	return nil
}
...
const file_conf_v1_kratos_conf_data_proto_rawDesc = "" +
	"\n" +
	"\x1econf/v1/kratos_conf_data.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\x1a\x1dconf/v1/kratos_conf_tls.proto\"\x9c9\n" +
	"\x04Data\x124\n" +
	...
	"\amongodb\x18\v \x01(\v2\x12.conf.Data.MongoDBH\x02R\amongodb\x88\x01\x01\x12B\n" +
	"\x10business_mongodb\x18\x0f \x01(\v2\x12.conf.Data.MongoDBH\x03R\x0fbusinessMongodb\x88\x01\x01\x12D\n" +
	"\x0eelastic_search\x18\f \x01(\v2\x18.conf.Data.ElasticSearchH\x04R\relasticSearch\x88\x01\x01\x127\n" +
	"\tcassandra\x18\r \x01(\v2\x14.conf.Data.CassandraH\x05R\tcassandra\x88\x01\x01\x12:\n" +
	"\n" +
	"clickhouse\x18\x14 \x01(\v2\x15.conf.Data.ClickHouseH\x06R\n" +
	"clickhouse\x88\x01\x01\x124\n" +
	"\binfluxdb\x18\x15 \x01(\v2\x13.conf.Data.InfluxDBH\aR\binfluxdb\x88\x01\x01\x12+\n" +
	"\x05doris\x18\x16 \x01(\v2\x10.conf.Data.DorisH\bR\x05doris\x88\x01\x01\x12+\n" +
	"\x05kafka\x18\x1e \x01(\v2\x10.conf.Data.KafkaH\tR\x05kafka\x88\x01\x01\x124\n" +
	"\brabbitmq\x18\x1f \x01(\v2\x13.conf.Data.RabbitMQH\n" +
	"R\brabbitmq\x88\x01\x01\x12(\n" +
	"\x04mqtt\x18  \x01(\v2\x0f.conf.Data.MqttH\vR\x04mqtt\x88\x01\x01\x124\n" +
	"\bactivemq\x18! \x01(\v2\x13.conf.Data.ActiveMQH\fR\bactivemq\x88\x01\x01\x12(\n" +
	"\x04nats\x18\" \x01(\v2\x0f.conf.Data.NATSH\rR\x04nats\x88\x01\x01\x12%\n" +
	"\x03nsq\x18# \x01(\v2\x0e.conf.Data.NSQH\x0eR\x03nsq\x88\x01\x01\x12.\n" +
	"\x06pulsar\x18$ \x01(\v2\x11.conf.Data.PulsarH\x0fR\x06pulsar\x88\x01\x01\x124\n" +
	"\brocketmq\x18& \x01(\v2\x13.conf.Data.RocketMQH\x10R\brocketmq\x88\x01\x01\x1a\xb2\x05\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\a_pulsarB\v\n" +
	"\t_rocketmqB\x8c\x01\n" +
	"\bcom.confB\x13KratosConfDataProtoP\x01Z;github.com/zhzblackc123/kratos-bootstrap/api/gen/go/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
...
var file_conf_v1_kratos_conf_data_proto_depIdxs = []int32{
	...
	3,  // 3: conf.Data.business_mongodb:type_name -> conf.Data.MongoDB
	7,  // 4: conf.Data.elastic_search:type_name -> conf.Data.ElasticSearch
	8,  // 5: conf.Data.cassandra:type_name -> conf.Data.Cassandra
	4,  // 6: conf.Data.clickhouse:type_name -> conf.Data.ClickHouse
	5,  // 7: conf.Data.influxdb:type_name -> conf.Data.InfluxDB
	6,  // 8: conf.Data.doris:type_name -> conf.Data.Doris
	10, // 9: conf.Data.kafka:type_name -> conf.Data.Kafka
	11, // 10: conf.Data.rabbitmq:type_name -> conf.Data.RabbitMQ
	12, // 11: conf.Data.mqtt:type_name -> conf.Data.Mqtt
	13, // 12: conf.Data.activemq:type_name -> conf.Data.ActiveMQ
	14, // 13: conf.Data.nats:type_name -> conf.Data.NATS
	15, // 14: conf.Data.nsq:type_name -> conf.Data.NSQ
	16, // 15: conf.Data.pulsar:type_name -> conf.Data.Pulsar
	17, // 16: conf.Data.rocketmq:type_name -> conf.Data.RocketMQ
	19, // 17: conf.Data.Database.connection_max_lifetime:type_name -> google.protobuf.Duration
	19, // 18: conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	19, // 19: conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	19, // 20: conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	18, // 21: conf.Data.MongoDB.auth_mechanism_properties:type_name -> conf.Data.MongoDB.AuthMechanismPropertiesEntry
	19, // 22: conf.Data.MongoDB.connect_timeout:type_name -> google.protobuf.Duration
	19, // 23: conf.Data.MongoDB.heartbeat_interval:type_name -> google.protobuf.Duration
	19, // 24: conf.Data.MongoDB.local_threshold:type_name -> google.protobuf.Duration
	19, // 25: conf.Data.MongoDB.max_conn_idle_time:type_name -> google.protobuf.Duration
	19, // 26: conf.Data.MongoDB.max_staleness:type_name -> google.protobuf.Duration
	19, // 27: conf.Data.MongoDB.server_selection_timeout:type_name -> google.protobuf.Duration
	19, // 28: conf.Data.MongoDB.socket_timeout:type_name -> google.protobuf.Duration
	19, // 29: conf.Data.MongoDB.timeout:type_name -> google.protobuf.Duration
	...
	19, // 34: conf.Data.InfluxDB.timeout:type_name -> google.protobuf.Duration
	19, // 35: conf.Data.InfluxDB.idle_connection_timeout:type_name -> google.protobuf.Duration
	19, // 36: conf.Data.ElasticSearch.discover_nodes_interval:type_name -> google.protobuf.Duration
	20, // 37: conf.Data.ElasticSearch.tls:type_name -> conf.TLS
	19, // 38: conf.Data.Cassandra.connect_timeout:type_name -> google.protobuf.Duration
	19, // 39: conf.Data.Cassandra.timeout:type_name -> google.protobuf.Duration
	20, // 40: conf.Data.Cassandra.tls:type_name -> conf.TLS
	19, // 41: conf.Data.Kafka.batch_timeout:type_name -> google.protobuf.Duration
	19, // 42: conf.Data.Kafka.read_timeout:type_name -> google.protobuf.Duration
	19, // 43: conf.Data.Kafka.write_timeout:type_name -> google.protobuf.Duration
